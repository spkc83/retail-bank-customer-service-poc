...
| [`../../poc/retail-bank-customer-service-poc/router.py`](../../poc/retail-bank-customer-service-poc/router.py) | CPU dual-head router loading, artifact verification, thresholds, context-aware classification. |
